                                ...
                                <table class="table table-hover table-bordered" id="userTable">
                                    ...
                                    <c:forEach items="${requestScope.users}" var="user">
                                        <tr>
                                            ...
                                            <td><a href="UserEditServlet?id=${user.id}"><span
                                                    class="fa fa-pencil">修改</span></a> <a
                                                    href="UserDelServlet?id=${user.id}"><span
                                                    class="fa fa-trash-o">删除</span></a>
                                                <a href="UserjsServlet?id=${user.id}"><span
                                                        class="fa fa-lock">解锁</span></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
